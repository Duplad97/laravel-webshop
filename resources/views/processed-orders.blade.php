...
@section('title', 'Feldolgozott rendelések')

@section('content')
    <div class="container">
            <h1 class="text-center">Feldolgozott rendelések</h1>
            <div class="row">
            @forelse ($orders as $order)
                    <div class="col-12 col-lg-4 mb-2">
                        <a href="{{ route('show.order', ['id' => $order->id]) }}" style="text-decoration: none !important; background-color: @if ($order->status === 'ACCEPTED') lightgreen @else lightpink @endif !important" class="card">
                            <div class="card-body">
